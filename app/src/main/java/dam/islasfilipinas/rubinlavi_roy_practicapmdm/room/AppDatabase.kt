                ...
                val instance = Room.databaseBuilder(
                    ...
                    .addCallback(object : Callback() {
                        override fun onCreate(db: SupportSQLiteDatabase) {
                            ...
                            db.execSQL("INSERT INTO recipes (title, category, imageUri, description) VALUES ('Turrón de almendras', 'Postres Navideños', '', 'Tuesta almendras y mézclalas con miel y clara de huevo batida. Extiende la mezcla en un molde y deja que se endurezca. Un dulce típico navideño.')")
